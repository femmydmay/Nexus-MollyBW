...
const [duration, setDuration] =  useState('')
  ...
  useEffect(() => {
    ...
    setDuration(date.toLocaleDateString('default', {month:"long", year:"numeric"}))
  ...
  return (
    <form className="md:flex  p-2">
      <div className="md:w-8/12  bg-white px-2 border-r border-slate-800 shadow rounded-l">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="mb-5">
            ...
            <select id="" className="w-full rounded p-2" {...register("duration")}>
      ...
      <div className="md:w-4/12 bg-amber-100 p-2 space-y-4 shadow rounded-r">
        ...
        <button className="float-right bg-slate-700 text-sm py-1 text-white px-2 rounded">Submit</button>
      </div>
